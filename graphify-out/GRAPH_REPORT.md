...
## Corpus Check
- 187 files · ~504,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8159 nodes · 24614 edges · 244 communities (228 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 681 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0620a0d1`
...
Cohesion: 0.26
Nodes (6): AnytypeClient, delete_archived_best_effort(), ListArchivedRequest<'a>, AsRef, Into, run_archived_search()
...
Cohesion: 0.14
Nodes (6): BackupExportFormat, BackupSpaceRequest, ExportFormat, PathBuf, Self, UpdateSpaceRequest

### Community 8 - "Pagination Core"
Cohesion: 0.09
Nodes (18): parse_message_attachment(), chat_message_path(), ChatAddMessageRequest, ChatEditMessageRequest, ChatHttpAddMessageRequest, ChatHttpEditMessageRequest, ChatSendTextRequest, MessageAttachment (+10 more)
...
Cohesion: 0.09
Nodes (19): Account, EventListener, EventStream, ListenSessionEventsSvc, MockChatServer, MockChatServerHandle, AtomicU64, Box (+11 more)
...
Cohesion: 0.18
Nodes (12): all_http_trace_levels_remain_metadata_only(), HttpRequest, log_http_status(), log_http_transport(), log_request(), log_response(), malformed_targets_fail_closed_across_standard_http_diagnostics(), non_whitespace_controls_fail_closed_across_aggregated_http_surfaces() (+4 more)

### Community 16 - "Changelog Concepts"
Cohesion: 0.14
Nodes (25): chunked_exact_limit_succeeds_without_content_length(), chunked_framing_cannot_bypass_limit_with_a_low_length_header(), content_length_exact_limit_succeeds(), diagnostic_path(), diagnostic_path_keeps_only_bounded_non_control_path_context(), DiagnosticChoice, DiagnosticEnvelope, first_streamed_byte_over_limit_fails() (+17 more)

### Community 17 - "Chat Resolution Client"
Cohesion: 0.17
Nodes (27): create_chat_object(), emit_message_rows(), format_sender(), handle(), listen_rest_sse(), load_space_names(), parse_message_attachments(), parse_message_blocks_json() (+19 more)
...
Cohesion: 0.11
Nodes (32): assert_public_mutation_sent_once(), assert_public_redirect_is_not_followed(), caller_supplied_reqwest_retry_policy_cannot_replay_a_mutation(), fixture_response(), format_bytes(), is_idempotent_method(), multipart_json_success_uses_generic_limit(), parse_retry_after() (+24 more)
...
Cohesion: 0.03
Nodes (75): assert_backup_args_equal(), AuthArgs, AuthCommands, backup_export_options(), backup_export_options_maps_include_flags_and_pb_json(), backup_export_options_maps_markdown_include_properties(), backup_target_always_uses_zip_extension_for_generated_name(), backup_target_dest_must_not_exist() (+67 more)
...
Cohesion: 0.04
Nodes (84): parse_message_mark(), append_sse_byte(), chat_layout_filter(), chat_stream_diagnostic_omits_url_credentials_query_and_fragment(), chat_stream_diagnostic_path(), ChatEditTextRequest, ChatHttpEvent, ChatMessage (+76 more)

### Community 28 - "Object Creation Builder"
Cohesion: 0.10
Nodes (34): ServeError, bounded_reader_recovers_at_the_next_line(), drain_frame(), encode_bounded_legacy_frame(), encode_legacy_message(), FirstFrame, FrameReadError, LegacyStdioTransport (+26 more)

### Community 29 - "Search API"
Cohesion: 0.02
Nodes (45): AutofillMode, Change, ChangeNoSnapshot, Code, Content, Context, DetailsSet, DeviceAdd (+37 more)
...
Cohesion: 0.12
Nodes (15): get_messages_after(), subscribe_previews(), ChatHttpEventStream, ChatHttpSseState, eof_finalization_moves_event_buffer_out_of_terminal_state(), grpc_attachments(), grpc_message_content(), BoxStream (+7 more)
...
Cohesion: 0.18
Nodes (9): deserialize_json(), HttpMetrics, RawHttpResponse, AtomicU64, Bytes, HeaderMap, Form, Req (+1 more)
...
Cohesion: 0.06
Nodes (64): BlockParticipant, ChangePayload, ChatMessage, DataviewRestrictions, DetailsSet, Export, FileEncryptionKey, FileInfo (+56 more)
...
Cohesion: 0.09
Nodes (23): bool_field(), ChatHttpListRequest, ChatMessagesPage, ChatState, HttpMessageWriteAttachment, HttpMessageWriteBody, HttpMessageWriteMark, last_modified_date() (+15 more)
...
Cohesion: 0.06
Nodes (51): Account, Add, Block, BlockField, Cafe, Config, Details, Device (+43 more)
...
Cohesion: 0.03
Nodes (27): Align, Block, BlockMetaOnly, Condition, Config, DataviewRestriction, DateFormat, Description (+19 more)
...
Cohesion: 0.02
Nodes (46): ActionType, Amount, AttachmentType, CardStyle, Cart, CartProduct, Code, CryptoCheckout (+38 more)
...
Cohesion: 0.05
Nodes (37): AddChatMessageResponse, AnytypeClient, chat_details_keys(), chat_search(), chat_search_space(), ChatClient<'a>, ChatCreateRequest, ChatDeleteMessageRequest (+29 more)
...
### Community 59 - "mod.rs"
Cohesion: 0.16
Nodes (18): chat_details(), delete_message_error(), edit_message_error(), filter_match(), filters_match(), match_condition_i32(), match_condition_string(), number_value() (+10 more)

### Community 60 - "Value"
Cohesion: 0.11
Nodes (19): description, $ref, type, description, properties, required, type, description (+11 more)

### Community 61 - "Value"
Cohesion: 0.20
Nodes (8): Checkbox, Date, Detail, RelationWithValue, RelationWithValuePerObject, Status, Tag, Value
...
Cohesion: 0.13
Nodes (38): add_cache(), add_complete(), cancel_all(), decode(), dispatch_modern(), encode_result(), error_response(), handle_cancellation() (+30 more)
...
Cohesion: 0.11
Nodes (47): unique_suffix(), with_test_context(), is_expected_member_lookup_error(), String, TestResult, test_active_member_exists(), test_get_member_by_id(), test_get_member_invalid_space() (+39 more)
...
### Community 76 - "String"
Cohesion: 0.17
Nodes (10): conditional_not_modified_status_is_preserved(), FileContentRequest, FilesClient, head_returns_file_metadata_without_a_body(), mock_file_client(), ranged_download_sends_width_and_conditional_headers(), AnytypeClient, JoinHandle (+2 more)
...
Cohesion: 0.13
Nodes (27): file_from_details(), file_from_http_upload(), FileSource, FileStyle, FileUploadRequest, filter_id_equal(), filter_to_dataview(), grpc_file_style() (+19 more)
...
### Community 83 - "Option"
Cohesion: 0.17
Nodes (11): CreateSpaceRequestBody, DeleteAllArchivedResult, DeleteBestEffortResult, ListArchivedRequest, NewSpaceRequest, AnytypeClient, Arc, String (+3 more)
...
Cohesion: 0.13
Nodes (11): MarkRange, Account, Info, Mark, Marks, MessageBlockEditorQuote, MessageBlockMessageQuote, MessageBlockText (+3 more)
...
Cohesion: 0.10
Nodes (20): AnytypeClient, ListPropertiesRequest, malformed_tag_pagination(), NewPropertyRequest, Arc, Color, Filter, Into (+12 more)
...
Cohesion: 0.20
Nodes (10): FileObject, filter_not_empty(), DateTime, FixedOffset, Sort, search_files(), sort_to_dataview(), PagedResult (+2 more)
...
Cohesion: 0.06
Nodes (20): backend_of(), blocks_json_rejected_with_transport_rest(), decode_order_id_arg(), decode_order_id_hex_roundtrip(), decode_order_id_non_hex_passthrough(), encode_order_id_hex(), hex_char(), hex_value() (+12 more)
...
Cohesion: 0.14
Nodes (19): authenticate(), broadcast_event(), build_chat_state(), build_event(), chat_add_value(), chat_delete_value(), chat_state_update_value(), chat_update_value() (+11 more)
...
### Community 105 - ".new"
Cohesion: 0.05
Nodes (44): description, properties, required, type, additionalProperties, description, type, description (+36 more)
...
### Community 109 - "Cli"
Cohesion: 0.17
Nodes (13): AnytypeClient, FileDownloadDestination, FileDownloadRequest, FileHttpUploadRequest, FileUploadResponse, http_upload_file(), rich_and_url_uploads_select_grpc(), AsRef (+5 more)
...
Cohesion: 0.11
Nodes (17): archived_object_from_search_result(), archived_relation_not_found(), archived_search_request(), dataview_filter_type_in(), normalized_search_result_id(), prime_cache_spaces(), Icon, Object (+9 more)
...
### Community 118 - "main"
Cohesion: 0.20
Nodes (8): Capture, ensure_trace_interest(), Arc, Dispatch, MakeWriter, Mutex, Write, Writer
...
### Community 131 - "Self"
Cohesion: 0.15
Nodes (6): FileListRequest, FileSearchRequest, Filter, Self, Vec, size_filter()
...
Cohesion: 0.25
Nodes (8): Dataview, Block, FileInfo, GroupOrder, Relation, View, SmartBlockSnapshotBase, ObjectOrder
...
Cohesion: 0.33
Nodes (3): AuthArgs, AuthCommands, Color
...
Cohesion: 0.14
Nodes (23): ObjectDescriptor, BackupSelection, descriptor_matches_type_filter(), fetch_descriptors_by_ids(), format_since_display(), object_to_descriptor(), parse_local_naive(), parse_local_since() (+15 more)
...
Cohesion: 0.07
Nodes (66): assert_error(), concise_summaries_preserve_closed_fields_only(), convert_space_summary(), convert_tag_summary(), convert_type_summary(), cursor_from(), DiscoveryHandlers, domain_handler_error() (+58 more)
...
Cohesion: 0.06
Nodes (36): apply_file_filters_list(), apply_file_filters_search(), delete_accepts_permanent(), delete_defaults_to_non_permanent(), discard_preload_parses_space_and_file_id(), download_http(), download_parses_space_object_and_rest_options(), download_via_heart_parses_object_and_destination() (+28 more)
...
Cohesion: 0.13
Nodes (9): file_path(), FileDeleteRequest, FileDiscardPreloadRequest, FileGetRequest, FilesClient<'a>, permanent_delete_sets_skip_bin_query(), Into, IntoIterator (+1 more)
...
Cohesion: 0.06
Nodes (38): ambiguity_candidates_are_bounded(), AmbiguityCandidatesError, anytype_classifiers_cover_every_directly_constructible_error_variant(), anytype_error_mapping_discards_upstream_response_text(), AnytypeErrorMapping, api_error(), assert_anytype_mapping(), candidate() (+30 more)
...
Cohesion: 0.07
Nodes (62): assert_error(), begin_page(), BoundedResult, continuation_advances_by_upstream_window_not_sparse_item_count(), contract(), ControlledFailurePolicy, conversion_and_encoding_failures_emit_one_safe_failure_diagnostic(), cursor_binding_includes_tool_limit_and_normalized_non_cursor_params() (+54 more)
...
Cohesion: 0.27
Nodes (5): file_type_filter(), file_type_from_mime(), FilePreloadRequest, FileType, preload_source_tracks_url_and_path()
...
Cohesion: 0.06
Nodes (37): description, properties, type, description, enum, type, description, $ref (+29 more)
...
Cohesion: 0.05
Nodes (41): items, description, properties, required, type, CreateMessageRequestParams, description, enum (+33 more)
...
Cohesion: 0.15
Nodes (13): properties, description, items, type, description, type, description, maximum (+5 more)
...
Cohesion: 0.07
Nodes (29): $ref, description, properties, type, ClientCapabilities, description, properties, type (+21 more)

### Community 444 - "type"
Cohesion: 0.07
Nodes (29): properties, properties, required, type, type, BooleanSchema, type, additionalProperties (+21 more)
...
Cohesion: 0.07
Nodes (64): aggregate_import_responses(), AppContext, apply_import_response(), archive_basename(), ArchiveCmpChanged, ArchiveCmpObject, ArchiveCmpReport, build_archive_cmp_report() (+56 more)

### Community 478 - "Result"
Cohesion: 0.03
Nodes (23): Formatter, Formatter, Path, run_inspector(), init_tracing(), main(), run(), init_tracing() (+15 more)
...
Cohesion: 0.08
Nodes (22): Any, CancellationToolServer, Arc, Future, Notify, Option, Output, RequestContext (+14 more)
...
- **Why does `Result` connect `Result` to `Space Pagination`, `Integration Test Suite`, `Authentication API`, `Chat Stream Builder`, `Filtering and Sorting`, `Object Models Utilities`, `Pagination Core`, `Client Configuration`, `Type Request Models`, `Test Retry Helpers`, `Changelog Concepts`, `Chat Resolution Client`, `Tag API`, `Property Value Models`, `Member Models`, `HTTP Retry Client`, `Property Lookup Helpers`, `Chat RPC Responses`, `Object Creation Builder`, `Chat Attachments Reactions`, `Message Content Formatting`, `Input Validation`, `Template API`, `Type Models`, `Cache Controls`, `Object Payload Models`, `Availability Verification`, `.call_tool`, `Object Update Examples`, `object_edit.rs`, `HTTP Request Methods`, `HTTP Metrics Reporting`, `Object CRUD Requests`, `Chat Read State`, `Object List Pagination`, `String`, `Self`, `Chat CRUD Tests`, `Agenda Example`, `Basic Filters Example`, `Interactive Auth Example`, `Value`, `stdio.rs`, `Type Property Example`, `stdio.rs`, `Consistency Retry Example`, `stdio.rs`, `p1_cross_space.rs`, `index.rs`, `p1_cross_space.rs`, `String`, `with_test_context_unit`, `files.rs`, `TestContext`, `decode.rs`, `mod.rs`, `PaginatedResponse<T>`, `find_list_object`, `NewTagRequest`, `unique_test_name`, `Widget`, `Style`, `VerticalAlign`, `CancelledNotificationParams`, `ResolveCandidate`, `chat.rs`, `ViewListObjectsRequest`, `Vec`, `view_handlers.rs`, `mock.rs`, `ProcessWatcher`, `stdio_conformance.rs`, `.create_template_fixtures`, `Member`, `result.rs`, `Cli`, `pagination_limit`, `FilePreloadRequest`, `main.rs`, `String`, `spaces.rs`, `resources.rs`, `main`, `route_aware_type_server`, `ViewMatchAccumulator`, `ObjectSummary`, `ArchiveReader`, `schema.rs`, `Processor`, `deserialize_vec_or_null`, `auth.rs`, `Key`, `Platform`, `auth.rs`, `object_output.rs`, `execute_object_import_batches`, `load_headless_config`, `MutationNumber`, `main`, `ListTemplatesRequest`, `Result`, `discovery.rs`, `AnytypeGrpcClient`, `view.rs`, `validation.rs`, `handle`, `views.rs`, `chat_messages.rs`, `.backup_space`, `parse_filters`, `auth.rs`, `FileContentResponse`, `AnytypeError`, `error.rs`, `handle`, `crypto.rs`, `test_chat_stream.rs`, `handler_support.rs`, `FileDownloadRequest`, `fix_doc_list_indents`, `TestResultTracker`, `AnyMcpServer`, `object_create.rs`, `verify.rs`, `main`, `main`, `logging.rs`, `.new`, `server.rs`, `test_collect_all_matches_total`, `PageLimit`, `properties.rs`, `.listen_session_events`, `.new`, `.new`, `Result`, `protocol.rs`, `runtime.rs`, `Self`, `mutation_value.rs`, `execute_create`, `execute_object_import_batches`, `Result`?**
  _High betweenness centrality (0.658) - this node is a cross-community bridge._
- **Why does `CallToolResult` connect `discovery.rs` to `Type Models`, `.new`, `view_handlers.rs`, `error.rs`, `.call_tool`, `.new`, `object_edit.rs`, `Attempt`, `headless_integration.rs`, `properties`, `$defs`, `handler_support.rs`, `CancelledNotificationParams`, `protocol.rs`, `AnyMcpServer`, `object_create.rs`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `$defs` connect `$defs` to `properties`, `.call_tool`, `.new`, `Member Integration Tests`, `ElicitRequestFormParams`, `Value`, `properties`, `properties`, `CancelledNotificationParams`, `properties`, `discovery.rs`, `properties`, `type`?**
