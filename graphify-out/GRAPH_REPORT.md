...
## Corpus Check
- 193 files · ~524,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8049 nodes · 24374 edges · 237 communities (218 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 676 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60631c18`
...
Cohesion: 0.08
Nodes (19): DataModel, authorize_template_resource(), collection_fixture_ownership_error(), complete_type_object_id_snapshot(), generic_pre_registered_id_cannot_claim_collection_provenance(), Mutex, PathBuf, Self (+11 more)
...
Cohesion: 0.12
Nodes (14): deserialize_vec_string_or_null(), FilterExpression, FilterOperator, join_values(), Query, D, Filter, From (+6 more)
...
Cohesion: 0.06
Nodes (31): HttpClient, AnytypeClient, Color, CreateObjectRequestBody, Icon, ListObjectsRequest, NewObjectRequest, Object (+23 more)
...
Cohesion: 0.13
Nodes (10): Condition, Filter, Into, IntoIterator, Number, Self, Serialize, String (+2 more)
...
Cohesion: 0.10
Nodes (22): all_http_trace_levels_remain_metadata_only(), deserialize_json(), HttpMetrics, HttpRequest, is_idempotent_method(), log_and_backoff(), log_http_status(), log_http_transport() (+14 more)
...
Cohesion: 0.06
Nodes (66): MarkRange, Account, Auth, Bookmark, Chat, ChatState, Content, ContentValue (+58 more)
...
Cohesion: 0.11
Nodes (26): Add, BlockField, ChatPreview, Config, Details, Field, Fields, Filter (+18 more)
...
Cohesion: 0.02
Nodes (46): ActionType, AttachmentType, CardStyle, Checkbox, Code, DataSource, Date, Detail (+38 more)
...
### Community 56 - "Self"
Cohesion: 0.47
Nodes (6): collection_view_fixture_accepts_exact_new_event_identity(), collection_view_fixture_binds_object_show_root_and_exact_block(), collection_view_fixture_rejects_preexisting_or_unproven_identity(), collection_view_response_description_is_redacted(), create_response(), requested_view()
...
### Community 60 - "Value"
Cohesion: 0.40
Nodes (5): collection_type_details(), collection_type_fixture_details_use_the_canonical_heart_layout(), Struct, Value, string_value()

### Community 61 - "Value"
Cohesion: 0.50
Nodes (4): metadata_is_safe(), IdentityPayload, Metadata, PayloadValue
...
Cohesion: 0.09
Nodes (38): file_from_details(), file_from_http_upload(), file_type_filter(), file_type_from_mime(), FileObject, FileSource, FileStyle, FileType (+30 more)

### Community 80 - "TestContext"
Cohesion: 0.08
Nodes (53): cleanup_template_resource(), collection_fixture_transport_error(), collection_fixture_transport_error_redacts_tonic_status(), collection_matches_fixture_provenance(), collection_object(), collection_view_fixture_rejects_missing_default_without_indexing_it(), collection_view_fixture_transport_error(), collection_view_fixture_transport_error_redacts_tonic_status() (+45 more)
...
Cohesion: 0.09
Nodes (23): AnytypeClient, CreateTagRequest, ListTagsRequest, NewTagRequest, refresh_cached_property_tags(), Arc, Color, Filter (+15 more)
...
Cohesion: 0.12
Nodes (32): ChatReadTypeArg, decode_order_id_arg(), decode_order_id_hex_roundtrip(), decode_order_id_non_hex_passthrough(), emit_message_rows(), encode_order_id_hex(), format_sender(), handle() (+24 more)
...
### Community 100 - "Vec"
Cohesion: 0.06
Nodes (42): Groups, BlockParticipant, ChangePayload, Dataview, DataviewRestrictions, DetailsSet, Filter, Group (+34 more)
...
Cohesion: 0.08
Nodes (34): handle(), list_command(), list_objects_accepts_view(), list_objects_requires_view(), AppContext, ListArgs, handle(), AppContext (+26 more)
...
Cohesion: 0.10
Nodes (54): AppContext, AuthArgs, AuthCommands, build_client(), ChatArgs, ChatCommands, ChatMessagesArgs, ChatMessagesCommands (+46 more)
...
Cohesion: 0.07
Nodes (77): assert_error(), checked_tag_count(), concise_summaries_preserve_closed_fields_only(), convert_property_summary(), convert_space_summary(), convert_tag_summary(), convert_type_summary(), cursor_from() (+69 more)
...
Cohesion: 0.04
Nodes (39): HandlerOperationErrorKind, main(), main(), main(), main(), main(), main(), main() (+31 more)
...
Cohesion: 0.04
Nodes (32): AutofillMode, Change, ChangeNoSnapshot, Content, Context, DetailsSet, DeviceAdd, DocumentCreate (+24 more)
...
Cohesion: 0.14
Nodes (19): decode_arguments(), invalid_arguments(), reject_static_cursor(), CancellationToken, ErrorData, JsonObject, ListResourcesResult, ListResourceTemplatesResult (+11 more)
...
Cohesion: 0.08
Nodes (48): ApplicationProfile, assert_catalog_contracts(), assert_valid_representative(), audit_schema(), canonical_json(), capabilities_are_static_complete_and_never_advertise_list_changed(), catalog_entries_equal_the_original_typed_contracts(), catalog_snapshot() (+40 more)
...
Cohesion: 0.06
Nodes (33): DiscoveryReference, finish_api_page(), PropertyListInput, PropertyPageParams, Cow, Deserialize, Fn, JsonSchema (+25 more)

### Community 322 - "properties.rs"
Cohesion: 0.05
Nodes (62): property(), AnytypeClient, assert_malformed_tag_pagination(), CreatePropertyRequestBody, deserialize_vec_string_or_null(), deserialize_vec_tag_or_null(), direct_property_get_is_cache_independent_and_exactly_scoped(), direct_property_get_validates_both_ids_before_io() (+54 more)

### Community 346 - "http_client.rs"
Cohesion: 0.07
Nodes (59): assert_public_mutation_sent_once(), assert_public_redirect_is_not_followed(), caller_supplied_reqwest_retry_policy_cannot_replay_a_mutation(), Capture, chunked_exact_limit_succeeds_without_content_length(), chunked_framing_cannot_bypass_limit_with_a_low_length_header(), content_length_exact_limit_succeeds(), DiagnosticChoice (+51 more)
...
### Community 370 - "SearchRequest"
Cohesion: 0.15
Nodes (14): AnytypeClient, Arc, Filter, Into, IntoIterator, Object, Option, S (+6 more)
...
Cohesion: 0.16
Nodes (34): AnyMcpServer, active_contains(), archived_contains(), arguments(), assert_archive_evidence(), assert_collection_view_continuation(), assert_cursor_continuation(), assert_fixture_space_continuation() (+26 more)
...
Cohesion: 0.13
Nodes (10): AnytypeClient, file_path(), FileDeleteRequest, FileDiscardPreloadRequest, FileGetRequest, FilePreloadRequest, FilesClient<'a>, FileUploadRequest (+2 more)

### Community 441 - "protocol.rs"
Cohesion: 0.09
Nodes (31): all_discovery_contracts_are_strict_bounded_read_tools(), property_list_tool(), server_status_tool(), ServerStatusOutput, space_list_tool(), tag_list_tool(), template_list_tool(), type_list_tool() (+23 more)

### Community 442 - "runtime.rs"
Cohesion: 0.07
Nodes (52): cancellation_releases_permit_for_next_operation(), concurrency_limit_bounds_waiting_operations(), ControlledFailureKind, ControlledOperationError, default_control_failure_diagnostic(), eof_before_initialize_is_a_clean_shutdown(), execute_applies_end_to_end_timeout(), execute_honors_request_cancellation() (+44 more)
...
Cohesion: 0.10
Nodes (36): clone_collection_view(), collection_view_fixture_clone_changes_only_id_and_name(), collection_view_fixture_code_error(), collection_view_fixture_cross_checks_every_rest_visible_field(), collection_view_fixture_error(), collection_view_ids_are_unique(), collection_view_snapshot_matches(), CollectionViewFixture (+28 more)
...
- **Why does `Result` connect `Result` to `Space Pagination`, `Integration Test Suite`, `Authentication API`, `Chat Stream Builder`, `Filtering and Sorting`, `Object Models Utilities`, `Pagination Core`, `Client Configuration`, `Member Integration Tests`, `Type Request Models`, `Property Setter Tests`, `Test Retry Helpers`, `Process Watcher`, `Changelog Concepts`, `Chat Resolution Client`, `Tag API`, `Property Value Models`, `Member Models`, `HTTP Retry Client`, `Property Lookup Helpers`, `Chat RPC Responses`, `Object Creation Builder`, `Chat Attachments Reactions`, `Message Content Formatting`, `Input Validation`, `Type Models`, `Cache Controls`, `Object Payload Models`, `Availability Verification`, `MutationIcon`, `.call_tool`, `Object Update Examples`, `object_edit.rs`, `HTTP Metrics Reporting`, `object_edit.rs`, `Object CRUD Requests`, `Chat Read State`, `Object List Pagination`, `.matches_returned`, `.new`, `String`, `Chat CRUD Tests`, `Agenda Example`, `Basic Filters Example`, `Interactive Auth Example`, `stdio.rs`, `Type Property Example`, `String`, `result.rs`, `index.rs`, `String`, `files.rs`, `TestContext`, `decode.rs`, `mod.rs`, `NewTagRequest`, `unique_test_name`, `chat.rs`, `ViewListObjectsRequest`, `Vec`, `view_handlers.rs`, `mock.rs`, `ProcessWatcher`, `stdio_conformance.rs`, `Member`, `pagination_limit`, `main.rs`, `String`, `spaces.rs`, `resources.rs`, `ObjectSummary`, `ArchiveReader`, `String`, `schema.rs`, `auth.rs`, `object_output.rs`, `execute_object_import_batches`, `load_headless_config`, `ListTemplatesRequest`, `Result`, `discovery.rs`, `.in_space`, `AnytypeGrpcClient`, `view.rs`, `validation.rs`, `handle`, `views.rs`, `chat_messages.rs`, `.backup_space`, `parse_filters`, `Option`, `auth.rs`, `FileContentResponse`, `AnytypeError`, `error.rs`, `handle`, `crypto.rs`, `test_chat_stream.rs`, `handler_support.rs`, `MutationNumber`, `object_generator.rs`, `RestCollectionViewFilter`, `common.rs`, `fix_doc_list_indents`, `TestResultTracker`, `handle`, `AnyMcpServer`, `object_create.rs`, `main`, `HandlerError`, `init_tracing`, `verify.rs`, `main`, `main`, `logging.rs`, `.new`, `server.rs`, `config.rs`, `test_collect_all_matches_total`, `PageLimit`, `properties.rs`, `.listen_session_events`, `http_client.rs`, `IdempotencyKey`, `.new`, `SearchRequest`, `Result`, `.new`, `HttpClient`, `Result`, `FilesClient<'a>`, `protocol.rs`, `runtime.rs`, `Self`, `mutation_value.rs`, `execute_create`, `execute_object_import_batches`, `Result`?**
  _High betweenness centrality (0.621) - this node is a cross-community bridge._
- **Why does `CallToolResult` connect `discovery.rs` to `Type Models`, `.new`, `view_handlers.rs`, `result.rs`, `.call_tool`, `.new`, `object_edit.rs`, `Attempt`, `headless_integration.rs`, `properties`, `$defs`, `handler_support.rs`, `required`, `protocol.rs`, `AnyMcpServer`, `object_create.rs`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `$defs` connect `$defs` to `properties`, `properties`, `ElicitRequestFormParams`, `_meta`, `properties`, `properties`, `properties`, `required`, `CancelledNotificationParams`, `properties`, `discovery.rs`, `AnyMcpServer`, `type`?**
