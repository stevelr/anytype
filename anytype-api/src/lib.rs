...
pub mod prelude {
    ...
    pub use crate::{
        ...
        chats::{
            ...
            ChatHttpAddMessageRequest, ChatHttpEditMessageRequest, ChatHttpEvent,
            ChatHttpEventStream, ChatHttpListMessagesRequest, ChatHttpListRequest,
            ChatHttpMessageStreamRequest, ChatHttpReadMessagesRequest, ChatListRequest,
            ChatListResult, ChatMessage, ChatMessageSearchPage, ChatMessageSearchResult,
            ...
            ChatState, ChatToggleReactionRequest, MessageAttachment, MessageAttachmentType,
            MessageBlock, MessageBlockEditorQuote, MessageBlockEmbed, MessageBlockLink,
            MessageBlockLinkType, MessageBlockMessageQuote, MessageBlockProcessor,
            MessageBlockText, MessageContent, MessageReaction, MessageTextMark,
            MessageTextMarkType, MessageTextRange, MessageTextStyle, SpaceChatsClient,
        },
        client::find_grpc,
        files::{
