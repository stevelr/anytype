...
| REST: `update_space(..).update`                   | Unit: omission/replacement/clear body serialization<br>Live: ignored disposable `test_space_description`                   | covered                                                            |
...
| gRPC: account-global `read_all_account`                 | Unit: legacy validation, typed transport failure, and generated-wire/source audit<br>Live: dedicated fresh account with complete chat/message/reaction inventory and cgroup-owned server teardown                                              | covered                                                                  |
