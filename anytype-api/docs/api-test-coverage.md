...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/http_client.rs` (50) and `src/http_timeout.rs` (5)                                                                                                                                                                                                  | unit    | absolute request and SSE phase deadlines, policy resolution, retry/replay safety, response ceilings, redirect policy, diagnostics redaction, timeout metrics, Retry-After parsing, credential generation                                                                                      |
